...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    if (DriverStation.isTest()) {
      ...
      driverXbox.b().whileTrue(
          drivebase.driveToPose(new Pose2d(new Translation2d(15, 1), Rotation2d.fromDegrees(0))));
  ...
  public Command getAutonomousCommand() {
    ...
    eventMap.put("RaiseElevator", new InstantCommand(() -> System.out.println("RAISING ELEVATOR")));
    eventMap.put("DepositCoral", new InstantCommand(() -> System.out.println("DEPOSITING CORAL")));
